        ...
        <div className="flex flex-col md:flex-row items-center mb-12">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg mb-4 animate-fade-in">
              ...
              Join us on an extraordinary mission to explore Near-Earth Objects (NEOs) through our cutting-edge space exploration program.
            
              As a leader in advancing knowledge of the solar system,
            
              we are pioneering new frontiers in human understanding and discovery.
